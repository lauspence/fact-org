...
import { publicationsApi } from '../services/strapi';
              ...
              <div className="grid md:grid-cols-2 gap-8">
                {featuredArticles.map((article) => (
                  <Link
                    ...
                    className="group bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all border border-gray-200 hover:border-emerald-300"
                  >
                ...
                {regularArticles.map((article) => (
                  ...
                  >
                    ...
                    <div className="p-5">
                      ...
                      <h3 className="text-lg font-bold text-gray-900 mt-2 mb-2 group-hover:text-emerald-600 transition-colors line-clamp-2">
                        {article.title}
                      </h3>
